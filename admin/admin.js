(() => {
  ...
  async function showAdmin() {
    ...
    await Promise.all([loadCategories(), loadPosts(), loadMedia(), loadViews(), loadInquiries(), loadVideos(), loadBooks(), loadGuides(), loadGuideTags()]);
    renderDashboard();
    navigate('dashboard');
  }
