(() => {
  ...
  const pjBookSheetCompare=(a,b)=>(Number(a.book_no)-Number(b.book_no))||(Number(a.sheet_no??a.start_page)-Number(b.sheet_no??b.start_page))||(pjFaceOrder(a.side)-pjFaceOrder(b.side));
