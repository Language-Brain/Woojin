...
export default async function handler(request, response) {
  ...
  try {
    ...
    html = html
      ...
      .replace('</head>', `${head}<link rel="stylesheet" href="/customer/article-lightbox.css?v=20260831-3"><link rel="stylesheet" href="/customer/reader-text-size.css?v=20260909-2"></head>`)
